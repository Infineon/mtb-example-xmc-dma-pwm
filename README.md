...
3. Observe the signal at P0.15 of the X2 connector. The signal should resemble the one shown in Figure 1:
...
![timing_diagram](images/timing_example.png)
...
![ccu4_1](images/ccu4_1.png)

![ccu4_2](images/ccu4_2.png)
